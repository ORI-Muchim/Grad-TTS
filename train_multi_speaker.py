...
if __name__ == "__main__":
    ...
    train_dataset = TextMelSpeakerDataset(train_filelist_path, text_cleaners, add_blank,
    ...
    test_dataset = TextMelSpeakerDataset(valid_filelist_path, text_cleaners, add_blank,
                                         n_fft, n_feats, sample_rate, hop_length,
                                         win_length, f_min, f_max)
